  ...
  return (
    <ContentLayout title="Tutorials">
      <div className="container mx-auto px-4">
        ...
        <p className="pb-5 mb-5 max-w-prose">
          Let&apos;s discover the Polkadot ecosystem through interactive
          tutorials and other learning resources. This website is a place for
          developers, to learn and study and to teach. The goal is to educate
          developers from diverse backgrounds about specific Polkadot and Kusama
