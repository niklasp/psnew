...
<Box type="info">There are many wallet browser extensions for the polkadot ecosystem. In this
...
<Box type="info">If you have never worked with _Context_ in react before or do not understand
when to use it, read the excellent
[react dev documentation on Context](https://react.dev/learn/passing-data-deeply-with-context).</Box>
