...
<Box type="info">You can of course write your tutorial without sticking to this guide, just open
...
test it - then this is the right time to follow along here.</Box>
