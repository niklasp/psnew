...
<Box type="info">You can choose any file name you like. You can also prefix every filename with a
...
to see how file naming can be handled.</Box>
...
<Box type="info">Please remember to use alt text for your images.</Box>
...
<Box type="info">Javascript code only works in `.mdx` files not in `.md` files, so make sure to
name your tutorial file accordingly.</Box>
